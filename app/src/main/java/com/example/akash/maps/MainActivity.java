                        ...
                        fbase.createUserWithEmailAndPassword(u_mail,u_pswd).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Toast. makeText(MainActivity.this, "registeration done", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(MainActivity.this, "registeration fail", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
                    ...
                    if (user != null){
                        user.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    Toast.makeText(MainActivity.this,"Check Your Mail for verification", Toast.LENGTH_SHORT).show();
